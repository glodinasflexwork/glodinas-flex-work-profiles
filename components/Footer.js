    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Glodinas Flex Work</h3>
            <p className="text-gray-400 mb-4">
              Connecting top talent with leading employers across Europe. Specialized recruitment solutions with multilingual support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>info@glodinasflexwork.nl</span>
              </li>
            </ul>
          </div>
        </div>

...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Placeholder: in real-world, you'd send this to a backend or email service
  ...
  return (
    <>
      <Head>
        <title>Contact | Glodinas Flex Work B.V.</title>
      </Head>
      <main className="min-h-screen bg-white p-8 text-gray-800">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {submitted && (
              <p className="text-green-600 pt-2">Thank you! We'll be in touch shortly.</p>
            )}
          </form>

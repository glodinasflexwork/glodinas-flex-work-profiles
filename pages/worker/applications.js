      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        {filteredApplications.length === 0 ? (
          <div className="text-center py-8">
            ...
            <div className="mt-6">
              <Link href="/jobs" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                  Browse Jobs
                </Link>
            </div>
          </div>

      ...
      <div className="pt-24 pb-6">
        <div className="container mx-auto px-4">
          <div className="bg-white shadow-md rounded-lg p-6 mb-6">
            <h1 className="text-2xl font-bold mb-2">Welcome, {dashboardData.profile?.firstName || 'Job Seeker'}</h1>
            <p className="text-gray-600">
              Manage your job applications, view saved jobs, and update your profile from your dashboard.
            </p>
          </div>
